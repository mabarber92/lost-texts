...
if __name__ == "__main__":
    ...
    # diff_mapper = multitextDiffMap(meta_path, corpus_base_path, clusters_path, pairwise_dir=pairwise_path)
    # diff_mapper.run_diff_pipeline("0845Maqrizi.Mawaciz", 1467, 1471, "./diff_pipeline_test", max_recursions=1)
